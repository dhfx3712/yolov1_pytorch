...
import torch
import sys
sys.path.append('/Users/admin/data/test_project/yolov1/YOLOv1')
from YOLO_V1_DataSet import VOCDataSet
dataSet = VOCDataSet(imgs_dir="/Users/admin/data/VOCdevkit/VOC2007/JPEGImages",annotations_dir="/Users/admin/data/VOCdevkit/VOC2007/Annotations",ClassesFile="/Users/admin/data/VOCdevkit/VOC2007/class_data.csv")
...
#--------------step5:torch.utils.tensorboard Feature Map------------
...
import torchvision.utils as vutils
epoch = 0
writer = SummaryWriter(log_dir='./log', filename_suffix=' [' + str(epoch) + '~' + str(epoch + 100) + ']')

from tqdm import tqdm

epoch = epoch + 1
# while epoch <= 200 * dataSet.classNum:
while epoch <= 0.2 * dataSet.classNum:
